...
- **Deep Insights Engine (1.0 Overhaul)**:
  - **Information Hierarchy**: Reorganized into three actionable sections: **Act** (Attention Needed & Financial Wins), **Understand** (Primary KPI Savings Rate Hero, Fixed & Structural Costs, 50/30/20 Rule, Income Sources), and **Explore** (Category Trends, Frequent Spending, Largest Transactions with Category Badges, and Travel Mode).
  - **Travel Mode & Vacation Analysis**: When trip expenses (flights, accommodations, dining, souvenirs) are logged under the **Travel** category, the engine automatically activates Travel Mode in the **Explore** section. It calculates daily burn rates, splits upfront structural costs vs. on-the-ground spending, breaks down spending by sub-type (Accommodation, Transit, Dining, Activities, Shopping), and isolates trip inflation from normal monthly budgets.
