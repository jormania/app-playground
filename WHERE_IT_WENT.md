...
- **Deep Insights Engine (1.0 Overhaul)**:
  ...
  - **Property Insights Engine**: Tracks real estate asset performance by analyzing rental income and property operating expenses (mortgage, repairs, HOA, property taxes). It computes period Net Cash Flow and Expense Ratio, checks maintenance deviation against historical baselines, highlights dominant structural costs, and isolates lumpy property expenditures from personal cash flow.
  - **Nora Insights Engine**: Dedicated child & family support analysis tracking expenditures across Education & Child Support, Sports & Extracurriculars, Healthcare, Clothing, and Gifts. It computes period spend, share of family budget, and average transactions while surfacing unusual seasonal deviations.
