// Yoru service worker: stale-while-revalidate for same-origin GETs, scoped to
// the Yoru page. Enables PWA installability and offline use after first visit.
// Same shape as Law of the Day's sw.js — caching only, no notifications.
const CACHE = 'yoru-cache-v1';
