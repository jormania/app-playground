// Kettlebell Training service worker: stale-while-revalidate for same-origin GETs, scoped to
// the Kettlebell Training page. Enables PWA installability and offline use after first visit.
// Same shape as Law of the Day's sw.js.
const CACHE = 'kettlebell-cache-v1';
...
const CACHE_PREFIX = 'kettlebell-cache-';
