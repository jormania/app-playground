...
export const DEMO_GARMENTS: Garment[] = [
  {
    ...
    wardrobeIds: ['demo_w_mum', 'demo_w_dad'], favourite: true, wearCount: 24, lastWorn: '2026-08-02', archived: false, retired: false,
  },
  {
    ...
    wardrobeIds: ['demo_w_mum'], favourite: false, wearCount: 11, lastWorn: '2026-07-28', archived: false, retired: false,
  },
  {
    ...
    wardrobeIds: ['demo_w_mum', 'demo_w_dad'], favourite: true, wearCount: 31, lastWorn: '2026-08-04', archived: false, retired: false,
  },
  {
    ...
    wardrobeIds: ['demo_w_dad'], favourite: false, wearCount: 6, lastWorn: '2026-03-14', archived: false, retired: false,
  },
  {
    ...
    wardrobeIds: ['demo_w_mum', 'demo_w_dad'], favourite: true, wearCount: 40, lastWorn: '2026-08-05', archived: false, retired: false,
  },
  {
    ...
    wardrobeIds: ['demo_w_mum'], favourite: false, wearCount: 18, lastWorn: '2026-07-30', archived: false, retired: false,
  },
  {
    ...
    wardrobeIds: ['demo_w_dad'], favourite: false, wearCount: 9, lastWorn: '2026-07-19', archived: false, retired: false,
  },
  {
    ...
    wardrobeIds: ['demo_w_mum'], favourite: false, wearCount: 7, lastWorn: '2026-06-22', archived: false, retired: false,
  },
  {
    ...
    wearCount: 5, lastWorn: '2026-07-12', archived: false, retired: false,
  },
  {
    ...
    wardrobeIds: ['demo_w_mum', 'demo_w_dad'], favourite: false, wearCount: 12, lastWorn: '2026-05-30', archived: false, retired: false,
  },
  {
    ...
    wearCount: 22, lastWorn: '2026-08-01', archived: false, retired: false,
  },
  {
    ...
    wardrobeIds: ['demo_w_dad'], favourite: false, wearCount: 28, lastWorn: '2026-02-27', archived: false, retired: false,
  },
  {
    ...
    wardrobeIds: ['demo_w_mum'], favourite: false, wearCount: 4, lastWorn: '2026-04-18', archived: false, retired: false,
  },
  {
    ...
    wardrobeIds: ['demo_w_mum', 'demo_w_dad'], favourite: true, wearCount: 52, lastWorn: '2026-08-05', archived: false, retired: false,
  },
  {
    ...
    wardrobeIds: ['demo_w_mum'], favourite: false, wearCount: 15, lastWorn: '2026-03-08', archived: false, retired: false,
  },
  {
    ...
    wardrobeIds: ['demo_w_dad'], favourite: false, wearCount: 8, lastWorn: '2026-07-25', archived: false, retired: false,
  },
  {
    ...
    wardrobeIds: ['demo_w_mum', 'demo_w_dad'], favourite: false, wearCount: 19, lastWorn: '2026-02-14', archived: false, retired: false,
  },
  {
    ...
    wardrobeIds: ['demo_w_mum'], favourite: true, wearCount: 33, lastWorn: '2026-08-04', archived: false, retired: false,
  },
  // One put-away row, so the archived filter has something real to hide.
  {
    id: 'demo_g_red_jumper', name: 'Red chunky knit', photoUrl: null, thumb: '#9a3232',
    category: 'Top', colours: ['red'], warmth: 'Warm', styles: ['cosy'],
    wardrobeIds: ['demo_w_dad'], favourite: false, wearCount: 47, lastWorn: '2025-11-03', archived: true, retired: false,
  },
  // One retired row, so we can test the Retired view.
  {
    id: 'demo_g_old_tshirt', name: 'Faded band tee', photoUrl: null, thumb: '#333333',
    category: 'Top', colours: ['black'], warmth: 'Light', styles: ['casual'],
    wardrobeIds: ['demo_w_dad'], favourite: false, wearCount: 150, lastWorn: '2022-01-01', archived: false, retired: true,
  },
]
