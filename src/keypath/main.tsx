...
// No fullscreenOnTap() here, unlike Radar-B: Chrome shows its "to exit full screen" toast
// on every entry, over the keys, and the landscape layout fits beside Chrome's toolbar
// (KEYPATH_TUTOR.md, "Landscape").
