...
// Accessible modal shell shared by Settings, Stats, and On this day. Handles the
// scrim, Esc-to-close, a focus trap, focus restore on close, and the dialog ARIA —
// so each modal only supplies its title and body.
