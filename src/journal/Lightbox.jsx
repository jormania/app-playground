...
// Full-size view for a delight's photo — deliberately minimal, unlike the shared
// Modal (no title bar, no focus trap): just the picture, as taken, over a scrim.
// The listing thumbnail gets the sepia/grain treatment; this is always the plain
// original.
