 ...
 * `swatch` is `[canvas, accent, ink]` — a live colour PREVIEW of the palette for the Settings
 * theme picker (the one place raw hex is legitimate outside the `[data-theme]` blocks in
 * journal.css, same swatch-of-itself exception Sol Odyssey makes).
