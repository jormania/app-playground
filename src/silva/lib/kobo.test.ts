...
describe('parseKoboDatabase — chapter locators', () => {
  async function dbWithChapters(): Promise<Uint8Array> {
    ...
    const db = new SQL.Database()
    db.run(`
      CREATE TABLE content (ContentID TEXT, BookTitle TEXT, Title TEXT, Attribution TEXT);
      ...
      INSERT INTO content VALUES ('book-1', NULL, 'Meditations', 'Marcus Aurelius');
      INSERT INTO content VALUES ('book-1!ch2', 'Meditations', 'Book II', 'Marcus Aurelius');
