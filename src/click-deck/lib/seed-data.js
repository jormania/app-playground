...
export const ALL_TAGS = [
  ...
  "Existential", "Cyberpunk", "Puzzle-Heavy", "Comedy", "Pirates", 
  "Voodoo", "Action-Adventure", "Mythology", "Time Travel", "Mystery", 
  "Supernatural", "Mature", "Dystopian", "Sci-Fi", "Comic Book Style", 
  "Biker", "Cinematic", "Serious", "Alien", "3D", "Noir", "Afterlife", 
  "Tank Controls", "Fantasy", "Epic", "Steampunk", "Automata", "Atmospheric", 
  "Linear", "Retro", "Pixel Art", "Surreal", "Americana", "Meta", 
  "Walking Simulator", "Tragedy", "Urban Fantasy", "Party Based", "RPG", 
  "Politics", "Southern Gothic", "Nostalgia", "Detective"
];
