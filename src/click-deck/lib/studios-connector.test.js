...
describe('StudiosConnector (Notion-backed, token + studios db configured)', () => {
  ...
  it('getStudios maps a Notion page into a studio, including the Steam Developer override', async () => {
    const page = {
      id: 'page-1',
      properties: {
    ...
    expect(studios).toEqual([{ id: 'page-1', name: 'Wadjet Eye Games', steamDeveloper: 'Wadjet Eye', notes: 'Point & click specialists' }])
  })
